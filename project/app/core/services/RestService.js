...
angular.module("services.rest-service", []).factory("RestService", RestService);
RestService.$inject = ["$http", "$q", "$rootScope", "ENV", "DialogsService"];


function RestService($http, $q, $rootScope, ENV, DialogsService) {
